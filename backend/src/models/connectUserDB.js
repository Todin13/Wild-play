...
const userSchema = new mongoose.Schema({ // This is the part what you your schema look like
  ...
  userNum: {
    ...
    unique: true, // User num should be unique
  ...
  userrole: {
    type: String, // The field type
    enum: ['user', 'service provider'], // Only both of these roles are accepted
    required: [true, "Userrole is required"] // Role is required, if not the web will give the error message  
  },
  billing_address: {
    type: String, // The field type
    //required: [true, "Address is required"]  // Address is required, if not the web will give the error message
  },
  driver_license: {
    type: String,  // The field type
    ...
    maxLength:[9, "Driver License should be exactly 9 characters"] // License should be only 9 haracters, else print the error msg
  },
  password: {
    type: String, // The field type
