    ...
    <div className="w-full rounded-2xl shadow-lg p-6 bg-voga-card border border-voga-border">
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                <div className="flex items-start"><CalendarIcon className="w-5 h-5 mr-2 mt-0.5 text-voga-accent" />
                    <div>
                ...
                <div className="flex items-start"><MapPinIcon className="w-5 h-5 mr-2 mt-0.5 text-voga-accent" />
                    <div>
                        <h3 className="text-sm font-semibold text-voga-text">Locations</h3>
                        {booking.pick_up_location && (
                        <p className="text-sm text-voga-title"><strong>Pickup:</strong> {booking.pick_up_location}</p>
                        )}
                        {booking.return_location && (
                        <p className="text-sm text-voga-title"><strong>Return:</strong> {booking.return_location}</p>
                        )}
                        {booking.delivery_location && (
                        <p className="text-sm text-voga-title"><strong>Delivery:</strong> {booking.delivery_location}</p>
                        )}
                    </div>
                </div>
                ...
                <div className="flex items-start">
                    ...
                    <div>
                        <h3 className="text-sm font-semibold text-voga-text">Promocode</h3>
                ...
                <div className="flex items-start">
                    ...
                    <div>
                        ...
                        <p className="text-lg font-bold text-voga-title">${booking.amount}</p>
                    </div>
                </div>
            </div>
                ...
                <div className="space-y-4">
                    <div className="flex items-start">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-voga-title">{booking.van_id.manufacturer} {booking.van_id.model}</p>
                            <p className="text-sm text-voga-title"><strong>Type:</strong> {booking.van_id.type}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start">
                        ...
                        <div>
                            <h3 className="text-sm font-semibold text-voga-text">Appearance</h3>
                            <p className="text-sm text-voga-title"><strong>Color:</strong> {booking.van_id.color}</p>
                            <p className="text-sm text-voga-title"><strong>Fuel:</strong> {booking.van_id.fuel}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start">
                        ...
                        <div>
                            <h3 className="text-sm font-semibold text-voga-text">Capacity</h3>
                            <p className="text-sm text-voga-title"><strong>Seats:</strong> {booking.van_id.seats}</p>
                            <p className="text-sm text-voga-title"><strong>Beds:</strong> {booking.van_id.beds}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start">
                        ...
                        <div>
                            <h3 className="text-sm font-semibold text-voga-text">Dimensions</h3>
                            <p className="text-sm text-voga-title">
                            {Array.isArray(booking.van_id.dimension)
                                ? booking.van_id.dimension.join("m × ") + "m"
                                : "N/A"}
                            </p>
                            <p className="text-sm text-voga-title"><strong>Weight:</strong> {booking.van_id.weight} kg</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="pt-2">
                <h3 className="text-sm font-semibold text-voga-text mb-2">Utilities</h3>
                <div className="flex flex-wrap gap-2">
                {(Array.isArray(booking.van_id.utilities)
                    ...
                    <span key={index} className="bg-green-700 text-white text-xs font-bold px-3 py-1 rounded-full" >
                        {utility}
                    </span>
                ))}
                </div>
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white p-6 rounded-lg shadow-xl text-center space-y-4 max-w-sm w-full">
                    ...
                    <div className="flex justify-center gap-4">
                        <Button onClick={onCancelBooking} className="bg-red-600 hover:bg-red-700" >
                        ...
                        <Button onClick={() => setShowConfirm(false)} className=" flex items-center bg-gray-300 hover:bg-gray-400 text-gray-800" >
                            <div className="flex items-center">                                
