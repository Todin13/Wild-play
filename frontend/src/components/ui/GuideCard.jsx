...
const GuideCard = ({ guide }) => {
  ...
  return (
    <div className="w-full max-w-[90vw] sm:max-w-[80vw] md:max-w-[65vw] lg:max-w-[50vw] xl:max-w-[40vw] 2xl:max-w-[35vw] rounded-3xl shadow-card p-8 md:p-10 xl:p-12 bg-voga-card border border-voga-border">
      <div className="space-y-8">
        ...
        <div>
          <h3 className="text-xl md:text-2xl font-semibold text-voga-text mb-3">Locations</h3>
            ...
            {guide.locations.map((loc, index) => (
              <li key={index} className="text-voga-title">
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-sm text-voga-textMuted">({loc.section})</span>
                </div>
                {loc.info && (
                  <p className="ml-8 text-sm md:text-base text-voga-text italic">{loc.info}</p>
                )}
              </li>
            ))}
          </ul>
        ...
        {guide.notes.length > 0 && (
          <div>
            ...
            <ul className="list-disc pl-8 text-base md:text-lg text-voga-title space-y-2">
