          ...
          {loading ? (
            ...
            <div className="bg-[#dcf2eb] shadow-md rounded-2xl p-6 max-w-4xl mx-auto space-y-6 text-left">
              ...
              <div className="space-y-3">
                ...
                {booking?.van_id?.isAvailable != null && (
                  <p><span className="font-semibold text-gray-700">Available:</span>{" "}{booking.van_id.isAvailable ? "Yes" : "No"}</p>
                )}
                {booking?.van_id?.info && (
                ...
                {booking?.van_id?.utilities && (
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {(Array.isArray(booking.van_id.utilities)
                      ...
                      <div
                        key={index}
                        className="bg-green-700 text-white font-bold text-sm px-3 py-1 rounded-full shadow-sm"
                      >
                        {utility}
                      </div>
                    ))}
